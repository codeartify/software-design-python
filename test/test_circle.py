...
class TestCircle(unittest.TestCase):
    ...
    def test_should_handle_coordinates_of_unequal_length(self):
        ...
        with self.assertRaises(ValueError):
            circle.count_contained_points(x_coordinates, y_coordinates)

    def test_should_handle_empty_x_coordinates(self):
        circle = Circle(0, 0, 2)
        y_coordinates = [8, 20, 15, -4]
        with self.assertRaises(ValueError):
            circle.count_contained_points(None, y_coordinates)
        with self.assertRaises(ValueError):
            circle.count_contained_points([], y_coordinates)

    def test_should_handle_empty_y_coordinates(self):
        circle = Circle(0, 0, 2)
        x_coordinates = [8, 20, 15, -4]
        with self.assertRaises(ValueError):
            circle.count_contained_points(x_coordinates, None)
        with self.assertRaises(ValueError):
            circle.count_contained_points(x_coordinates, [])
    ...
    def test_should_count_contained_points(self):
        ...
        self.assertEqual(3, circle.count_contained_points(x_coordinates, y_coordinates))
    ...
    def test_should_count_contained_points_when_moved_to_new_location(self):
        ...
        self.assertEqual(1, circle.count_contained_points(x_coordinates, y_coordinates))
    ...
    def test_should_count_contained_points_when_resized_for_new_area(self):
        ...
        self.assertEqual(3, circle.count_contained_points(x_coordinates, y_coordinates))
        circle.resize(40)
        self.assertEqual(5, circle.count_contained_points(x_coordinates, y_coordinates))
        circle.resize(1)
        self.assertEqual(0, circle.count_contained_points(x_coordinates, y_coordinates))
